...
<center>
    ...
    <div class="col-md-6 order-md-3 text-left">
        <form class="needs-validation" name=form1 action="<c:url value="http://localhost:8080/hanium/searchRecruitment"/>" method="post">
            <div class="mb-3">
...
<center>
    <h4 class="mb-3">채용공고 상세검색 </h4>
    <div class="col-md-6 order-md-3 text-left">
        <form class="needs-validation" name=form1 action="<c:url value=""/>" method="post">
            <div class="mb-3">
                <label for="work_location">근무지역 </label>
                <select class="custom-select d-block w-100" name="work_location">
                    <option selected>서울 </option>
